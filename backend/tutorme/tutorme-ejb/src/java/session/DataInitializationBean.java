...
//            em.flush();
//            offerSession.acceptOffer(offer.getOfferId());
//        } catch (Exception ex) {
//            ex.printStackTrace();
//        }
//    }
...
public class DataInitializationBean {
    ...
    private void initJobListings2() {
        ...
        try {
            ...
            jobListing = jobListingSession.createJobListing(tutorSession.retrieveTutorByEmail("HsiangHui@gmail.com").getPersonId(), combo1, 45.0, "Anyday except weekends", "North", "Math P1 to P4", "Negotiable prices");
            jobListing = jobListingSession.createJobListing(tutorSession.retrieveTutorByEmail("HsiangHui@gmail.com").getPersonId(), combo4, 35.0, "Anyday except weekends", "North", "Science P3 to P6", "Negotiable prices");
            jobListing = jobListingSession.createJobListing(tutorSession.retrieveTutorByEmail("EneltonSatria@gmail.com").getPersonId(), combo2, 15.0, "Monday Only", "South", "Math P2 to P5", "Fixed prices");
            jobListing = jobListingSession.createJobListing(tutorSession.retrieveTutorByEmail("EneltonSatria@gmail.com").getPersonId(), combo5, 65.0, "Monday Only", "South", "Science P1 to P4", "Fixed prices");
            jobListing = jobListingSession.createJobListing(tutorSession.retrieveTutorByEmail("KengThong@gmail.com").getPersonId(), combo3, 50.0, "Weekdays Only", "East", "Science P3 to P6", "PM me fast");
            jobListing = jobListingSession.createJobListing(tutorSession.retrieveTutorByEmail("KengThong@gmail.com").getPersonId(), combo6, 70.0, "Weekdays Only", "East", "Science P1,3,5,6", "PM me fast");
            jobListing = jobListingSession.createJobListing(tutorSession.retrieveTutorByEmail("BrandonNg@gmail.com").getPersonId(), combo1, 25.0, "Weekend Only", "West", "Math P1 to P4", "Flex prices");
            jobListing = jobListingSession.createJobListing(tutorSession.retrieveTutorByEmail("BrandonNg@gmail.com").getPersonId(), combo4, 35.0, "Weekend Only", "West", "Science P3 to P6", "Flex prices");
            jobListing = jobListingSession.createJobListing(tutorSession.retrieveTutorByEmail("SohYibin@gmail.com").getPersonId(), combo2, 20.0, "Weekday Night Only", "Anywhere", "Math P2 to P5", "Negotiable prices for friendly customers");
            jobListing = jobListingSession.createJobListing(tutorSession.retrieveTutorByEmail("SohYibin@gmail.com").getPersonId(), combo5, 35.0, "Weekday Night Only", "Anywhere", "Science P1 to P4", "Negotiable prices for friendly customers");
            em.flush();
